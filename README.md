...
<img src="https://img.shields.io/badge/Pipeline-$180K-00D26A?style=for-the-badge" />
<img src="https://img.shields.io/badge/Meetings-15%2B%2FMonth-2383E2?style=for-the-badge" />
<img src="https://img.shields.io/badge/Copy_Score-91.7%2F100-FF6B6B?style=for-the-badge" />
<img src="https://img.shields.io/badge/Reply_Rate-5--10%25-7C3AED?style=for-the-badge" />
...
![SalesFlo Cold Outreach Strategy](./cold-outreach-strategy.svg)

*Click image to view full-size SVG diagram*
...
```mermaid
graph TD
    A[1. Fetch Uncontacted Leads] -->|Database Query| B[2. AI Personalization]
    B -->|Groq LLM| C[3. Send Email]
    C -->|SMTP Your Domain| D[4. Update Database]
    D -->|Timestamp + Status| A

    style A fill:#2383E2,stroke:#fff,stroke-width:2px,color:#fff
    style B fill:#00D26A,stroke:#fff,stroke-width:2px,color:#fff
...
![Strategy](https://img.shields.io/badge/Strategy-Proven-00D26A?style=flat-square)
![Automation](https://img.shields.io/badge/Automation-AI_Powered-2383E2?style=flat-square)
![Ownership](https://img.shields.io/badge/Ownership-100%25-7C3AED?style=flat-square)
![Results](https://img.shields.io/badge/Results-$180K_Pipeline-FF6B6B?style=flat-square)
